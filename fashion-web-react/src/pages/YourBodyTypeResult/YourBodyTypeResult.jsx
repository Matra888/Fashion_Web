...
import celebrityExamplePic from "../../assets/hourglass-example.jpg";
import celebrityExamplePicBad from "../../assets/hourglass-example-bad.jpg";
    ...
    <main>
      <div className="container-fluid min-vh-100 bg-dark p-5 d-flex flex-column align-items-center justify-content-center">
        ...
        <div className="container d-flex flex-wrap p-5 my-5">
          <img
            src={celebrityExamplePicBad}
            className="example-image col-12 col-md-3"
            alt=""
          />
          <img
            src={celebrityExamplePic}
            className="example-image col-12 col-md-3"
            alt=""
          />

          <p id="do" className="text-light col-12 col-md-4 col-lg-5 m-4 mt-0">
